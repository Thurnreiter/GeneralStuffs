program Nathan.Dependency.V2.UnittestX;
...
uses
  ...
  Test.Xml.Worker in 'Test.Xml.Worker.pas',
  Test.Service in 'Test.Service.pas',
  Test.Dto.Serializer in 'Test.Dto.Serializer.pas',
